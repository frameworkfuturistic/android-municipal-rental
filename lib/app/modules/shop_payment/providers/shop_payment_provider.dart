...
class ShopPaymentProvider extends GetConnect {
  ...
  Future<APIResponse> postShopPay(var shopID, Map data) async {
    String url = Strings.base_url + 'shoppayment/'+ shopID.toString();
    // var token = 'Bearer ' + Strings.token;
    String token = await CommonUtils.getToken();
    token = 'Bearer ' + token;
