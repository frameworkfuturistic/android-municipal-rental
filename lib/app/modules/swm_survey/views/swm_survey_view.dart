...
class SwmSurveyView extends GetView<SwmSurveyController> {
  const SwmSurveyView({Key? key}) : super(key: key);
  @override
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text("SWM SURVEY", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: 20),),
                  ),
                  ListView.builder(
                      shrinkWrap: true,
